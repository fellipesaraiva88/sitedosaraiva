...
const categoryConfig = {
  prompt: { icon: Sparkles, label: "Prompt", color: "text-yellow-400", bg: "bg-yellow-400/10" },
  tool: { icon: Wrench, label: "Ferramenta", color: "text-primary", bg: "bg-primary/10" },
  analysis: { icon: BarChart3, label: "Análise", color: "text-blue-400", bg: "bg-blue-400/10" },
  thought: { icon: Brain, label: "Pensamento", color: "text-purple-400", bg: "bg-purple-400/10" },
};
...
const ContentDetail = () => {
  ...
  const imageUrl = (content as any).image_url;
  const websiteUrl = (content as any).website_url;
  const pricing = (content as any).pricing;
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-3 flex-wrap">
                    ...
                    {content.featured && (
                      <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest text-yellow-400 mono px-2.5 py-1 rounded-md bg-yellow-400/10">
                      ...
                      <div className="space-y-3">
                        ...
                        {content.featured && (
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-medium text-yellow-400 flex items-center gap-1"><Star className="w-3 h-3" /> Destaque</span>
                          </div>
                        )}
                      </div>
