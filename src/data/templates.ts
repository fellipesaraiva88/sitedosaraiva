...
export const typeConfig: Record<TemplateType, { emoji: string; label: string; color: string }> = {
  skill: { emoji: "🎨", label: "Skill", color: "text-orange-400" },
  agent: { emoji: "🤖", label: "Agent", color: "text-blue-400" },
  command: { emoji: "⚡", label: "Command", color: "text-yellow-400" },
  hook: { emoji: "🪝", label: "Hook", color: "text-green-400" },
  mcp: { emoji: "🔌", label: "MCP", color: "text-purple-400" },
  setting: { emoji: "⚙️", label: "Setting", color: "text-gray-400" },
};
